...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    // Apply global overflow-x-hidden to the body and html
    ...
    <div className="shadow-md bg-white dark:bg-gray-900 dark:text-white duration-200 relative z-40">
      ...
      <div className="bg-primary dark:bg-se transition-colors duration-200 py-2">
        <div className="flex justify-between h-10 items-center md:px-20 drop-shadow-md">
          ...
          {/* Mobile Menu */}
          <div
            className={`absolute flex flex-col items-center bg-white w-full gap-6 top-12 right-0 transition-transform transform  dark:bg-gray-700 ${isOpen ? "opacity-100 animate-slide-in-left translate-x-0" : "opacity-0 translate-x-full"}`}
            style={{
              maxWidth: '100%',
              overflowX: 'hidden',
              left: '0',
          ...
          >
            ...
            <Link to="/testimonials" onClick={() => setIsOpen(false)}><li className="list-none subpixel-antialiased text-md font-semibold hover:bg-[#f2d2cf] rounded-md hover:scale-105 transition-transform">Testimonials</li></Link>
          </div>
      ...
      <div className="hidden md:flex justify-center items-center animate-fade-in bg-white dark:bg-gray-900 py-2">
        <ul className="flex justify-between items-center lg:gap-18 md:gap-10 xl:gap-24 text-gray-900 dark:text-gray-300 text-sm px-4 subpixel-antialiased font-semibold">
          ...
          <Link to="/testimonials"><li className="xl:p-2 lg:p-4 md:p-4 hover:bg-[#f2d2cf] dark:hover:text-black rounded-md hover:scale-100 transition-transform">Testimonials</li></Link>
        </ul>
      </div>
    </div>
  );
